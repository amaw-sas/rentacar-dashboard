...
// Standalone chat test harness (client UI). Talks to this deployment's /api/chat
// so the team can exercise the bot manually. Not part of the product; the page
// wrapper (page.tsx) 404s this in production so the public site never exposes it.
...
export function ChatTestClient() {
