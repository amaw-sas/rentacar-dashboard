...
const TYPE_LABELS: Record<string, string> = {
  ...
  whatsapp_pre_pickup_week: "WhatsApp recordatorio (1 semana antes)",
  whatsapp_pre_pickup_3d: "WhatsApp recordatorio (3 días antes)",
  whatsapp_pre_pickup_same_day_am: "WhatsApp recordatorio mismo día (AM)",
  whatsapp_pre_pickup_same_day_pm: "WhatsApp recordatorio mismo día (PM)",
  whatsapp_post_pickup_am: "WhatsApp post-recogida (AM)",
  whatsapp_post_pickup_pm: "WhatsApp post-recogida (PM)",
