...
export async function buildSystemPrompt(
  ...
  return [
    ...
    "- Horas extra: si la hora de DEVOLUCIÓN es más tarde que la de RECOGIDA (o ajustaste la hora de recogida para cuadrar con el horario de la sede), avísale en ese momento que esas horas adicionales se cobran aparte de los días completos y suman al valor. Dilo al definir la hora de entrega, antes de cotizar.",
