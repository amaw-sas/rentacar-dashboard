...
export async function buildSystemPrompt(
  ...
  return [
    ...
    "  3) Pide confirmación EXPLÍCITA ('¿Confirmo tu reserva?') UNA sola vez. Si el cliente responde afirmativamente de CUALQUIER forma ('sí', 'sí confirmo', 'confirmo', 'dale', 'hazlo', 'confírmala', 'ok', 'listo', 'de una', 'sí por favor', etc.), tu ÚNICA acción válida en ESE mismo turno es llamar `crear_reserva` de inmediato. Está TERMINANTEMENTE PROHIBIDO volver a resumir la reserva, volver a preguntar '¿confirmo?' o pedir un segundo sí: el cliente ya dijo que sí y repetir la pregunta es un error grave. Solo te abstienes de reservar si el cliente AÚN no ha dado un sí claro (en ese caso espera, sin repetir el resumen). NO llames `crear_reserva` sin un sí claro.",
