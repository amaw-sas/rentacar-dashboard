...
export async function freeFormSystem(brand: string): Promise<string> {
  ...
  return [
    ...
    "Fotos/imágenes: NO puedes enviar fotos ni imágenes de los vehículos por este chat; NUNCA prometas enviarlas ni digas 'te las envío'. Si piden fotos, explica que se alquila por gama (el modelo se asigna en sede) y describe la gama en palabras.",
