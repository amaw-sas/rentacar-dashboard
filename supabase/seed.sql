...
BEGIN
  ...
  INSERT INTO public.locations (rental_company_id, code, name, slug, city, city_id, schedule) VALUES
    ...
    (localiza_id, 'ACKAL', 'Cali Sur Camino Real', 'cali-sur-camino-real', 'cali', city_cali, '{"display": "Lun-Vie 08:00-17:00 | Sáb 08:00-14:00 | Dom y fest Cerrado"}'),
    (localiza_id, 'ACKJC', 'Cali Norte Chipichape', 'cali-norte-chipichape', 'cali', city_cali, '{"display": "Lun-Vie 08:00-17:00 | Sáb 08:00-14:00 | Dom y fest 08:00-14:00"}'),
    ...
    (localiza_id, 'AASMR', 'Santa Marta Aeropuerto', 'santa-marta-aeropuerto', 'santa-marta', city_santa_marta, '{"display": "Todos los días 07:00-21:00"}'),
